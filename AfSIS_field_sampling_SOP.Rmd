...
```{r, echo=FALSE, fig.align="center", fig.cap="**Fig. 3:** Schematic of 100 m^2^ composite soil sampling plots. Each of the black dots represents an auger location, plus a center point, where a GPS reading is collected. Ensure that you stand at that spot when completing the associated KoboCollect form.", out.width = '45%'}
...
Drone flights also provide great additional context for interpreting field observations and sample data. There are quite robust models available for under 1,000 U$. These can usually be flown without a license or filing a flight plan when they are <250 gm in weight. They are also very simple to operate from a survey vehicle, with minimal training. Check with the local aviation authorities as to wether they are legal to operate in your project ROIs. Watch out for bird attacks and shotguns.
